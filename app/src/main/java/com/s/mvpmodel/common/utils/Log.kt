...
package com.s.mvpmodel.common.utils
...
object LogUtils {
    ...
    fun init(context: Context) {
        Logger.addLogAdapter(object : AndroidLogAdapter(PrettyFormatStrategy.newBuilder().tag(TAG).methodCount(METHOD_COUNT).build()) {
